...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if !ok {
		t.Errorf("objec is not a boolean got a %T (%+v) instead", obj, obj)
		return false
	}
...
func TestReturnStatements(t *testing.T) {
	tests := []struct {
		...
		{"return 2 * 5; 9", 10},
		{"9;return 20 / 10; 9;", 2},
		// FIXME: The test for the following hangs, investigate why
...
func TestFunctionObject(t *testing.T) {
	...
	if fn.Parameters[0].String() != "x" {
		t.Fatalf("paramaeter is not 'x'. got %q", fn.Parameters[0])
	}
